...
def gravarArquivo():
    ...
    arquivo = open("/Users/rlresende/Documents/viccenzo.iftm/projeto/produtos.txt", "w")
...
def inserirClientes():
    novoCliente = Cliente(textoCPF.get("1.0","end-1c"),textoNome.get("1.0","end-1c"),textoEndereço.get("1.0","end-1c"),textoTelefone.get("1.0","end - 1c")) # type: ignore
...
#o arquivo
arquivo = open("/Users/rlresende/Documents/viccenzo.iftm/projeto/produtos.txt", "r")
contadorDelinha = 0
