...
def gravarArquivos():
    ...
    # a.py opção 5, devemos gravar as informações no arquivos novamente
...
def inserirClientes():
    novoCliente = Cliente(textoCPF.get("1.0", "end-1c"), textoNome.get("1.0", "end-1c"),
                          textoEndereco.get("1.0", "end-1c")), textoTelefone.get(("1.0", "end-1c"))  # type: ignore
...
clientes = []
# O comado open abre um arquivo a.py lê o mesmo.O comado possui dois parâmetros
...
for linha in arquivo.readlines():
    ...
    if (contadorDelinha % 4 == 0):
        ...
        novoCliente = Cliente(CPF, nome, endereco, telefone)  # type: ignore
...
bg = tk.PhotoImage(file="/Users/rlresende/Documents/viccenzo.iftm/projeto/fundo.png")
