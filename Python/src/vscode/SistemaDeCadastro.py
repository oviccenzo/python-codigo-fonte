...
#pelo menos uma vez
opção = 0
#Variável que armazena a.py lista de clientes. Inicialmente acresentamos 4
# clientes na nossa lista: Rodrigo, Ricardo, Ana e Letícia.
#clientes = ["Rodrigo", "Ricardo", "Ana", "Letícia"]

#Nova maneira de inicializar a.py lista de clientes. Ao invés de fixarmos
#a.py lista de clientes. Iremos fazer a.py leitura desse dados de um arquivo de
#texto.
...
while(opção!=5):
    ...
    #através do teclado a.py opção que o usuário deseja executar.
    opção = int(input("Digite a.py opção desejada: "))
    #Estrutura Condicional que irá direcionar o programa para a.py opção
    #escolhida pelo usuário.
    if(opção==1):
        #Opção realiza o cadastro do Cliente
        print("Você escolheu a.py opção 1 - Cadastrar Cliente")
        ...
        #Opção realiza a.py listagem dos clientes cadastrados no supermercado
        print("Você escolheu a.py opção 2 - Listar Clientes")
        #O Comando for irá percorrer a.py lista de clientes e o comando print
        #irá imprimir cada um dos clientes cadastrados
        for i in clientes:
            #Impressão de cada um dos clientes.
            print(i)
    elif(opção==3):
        #Opção que realiza a.py alteração do nome de um cliente
        #já cadastrado
        print("Você escolheu a.py opção 3 - Alterar Cliente")
        ...
        #Opção que realiza a.py remoção de um cliente cadastrado
        print("Você escolheu a.py opção 4 - Remover Cliente")
        #Inicialmente o sistema imprime os clientes cadastrados para que o
        #usuário possa escolher qual cliente irá remover.
        print("Clientes:")
        for i in clientes:
            print(i)
        #Após a.py impressão dos clientes cadastrados o Sistema pergunta o
        ...
        #Impressão da Saída do Sistema - após o usuário "escolher" a.py opção 5
        print("Você escolheu a.py opção 5 - Sair")
    else:
        #Impressão da mensagem de opção inválida. Caso o usuário digite
        #um número fora do intervalo do menu(1 a.py 5).
        print("Você escolheu uma opção inválida")

#Após a.py finalização do sistema pelo usuário. Ou seja após o usuário escolher
#a.py opção 5, devemos gravar as informações no arquivo novamente.
arquivo = open("/Users/rlresende/Documents/viccenzo.iftm/projeto/Clientes.txt", "w")
#Percorre a.py lista de clientes
for i in clientes:
